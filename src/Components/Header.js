...
function Header() {
  ...
  return (
    <header className="container mx-auto py-4 max-w-7xl relative">
  <nav className={`${!isOpen ? "hidden md:flex" : "flex"} justify-center`}>
    <ul className="flex flex-col md:flex-row items-center gap-6 font-medium dark:text-light-content">
        ...
        <ul className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 items-center gap-5">
          <li>
